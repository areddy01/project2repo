	...
	<?php  } ?>
	 ...
	 <!--
	 	...
	 	<tr>
				...
				<td style="width: 87px" >
				<input name="Text191" id="otherfees78"  onblur="return validat_nulls('#otherfees78')" type="text" style="width: 128px" value="<?php echo $data; ?>"/></td>
				<td style="width: 61px">&nbsp;</td>
				<td class="auto-style9" style="width: 105px"><strong>Total Income</strong></td>
				<td style="width: 84px"><input name="Text194" id="otherfees79"  onblur="return validat_nulls('#otherfees79')" type="text" style="width: 128px"  /></td>
			</tr>
			<tr>
				<td style="width: 118px"  >&nbsp;</td>
				<td style="width: 76px" >&nbsp;</td>
...
<br/><br/><input id = "otherfees" name="Submit1" type="submit" value="submit" style="width: 111px"  />
