			...
			<p><form name = "" method = "post" id ="addschool" action = "/outside_controller/adddatabase/"  value = ""  style="width:30%">
			    ...
			    <table cellspacing="10" style="width: 271px; height: 108px">
					...
					<td><strong>School </strong> </td>
						...
						<input id = "searchschool" type = "text" value = "" name = "schoolname[school]" style="width: 166px" /></td>
						<tr>
						...
						<td colspan="2" align="center"><input type = "submit" value = "Submit" name ="submit" onclick="return add_school()"/></td>
						<span id = "adderr" style = "color:red;display:none;">Please&nbsp;fill&nbsp;the&nbsp;redmarked&nbsp;field</span>
