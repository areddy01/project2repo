...
<form method = "post" id ="" action = "/admin/addcost/?info=<?php echo $info; ?>" style="width:90%" >
<table>
<tr>
...
<?php } ?>
   ...
   <td class="auto-style9" style="width: 82px"><?php echo $row1++; ?> </td>
	 ...
	 <td> <input type="text" name="quantity[0][<?php $row ?>]" value="<?php if (isset($arr['getvalue'][$row]['amount']))  echo $arr['getvalue'][$row]['amount']; ?>">    </td>
	 <td><select name="quantity[1][<?php $row ?>]" style="width: 89px">
	 ...
	 <input type="text" name="quantity[2][<?php $row ?>]" disabled="disabled" value="" class="auto-style10" style="width: 116px"/>    </td>
