...
$result = $this->db->query("SELECT assessment_id , school_name FROM assessment a , school b WHERE a.school_code ='".$output['school_code']."' AND a.assessment_status = 1 AND a.school_code = b.school_code AND b.school_name = '".trim($output['school_name'])."'")->result_array();
...
$this->load->view('admin_view', $schoolinfo);
}
}
