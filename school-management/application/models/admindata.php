...
/* pushing school data in database */
   ...
   function GetSchooDB($limit, $start, $value) {
		...
		$query = $this->db->query("SELECT a.school_code, b.assessment_status, a.school_name FROM school a left join assessment as b on a.school_code =b.school_code limit $start,$limit ")->result_array();     /*if ($query->num_rows() > 0) {
