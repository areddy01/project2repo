...
<td style="width: 21%" ><table style="width: 27%; height: 88px;">
	...
	<tr>
		...
		<td class="auto-style5" style="width: 88px"><input id="teacher0" name="Text244" style="width: 101px" type="text" maxlength="4" onblur="return validat_numeric('#teacher0');" /></td> 
		

		<td style="width: 102px" class="auto-style4"><input id="teacher1" name="Text245" style="width: 101px" type="text" maxlength="4" onblur="return validat_numeric('#teacher1');"/></td>

	</tr>
	<tr>
		<td class="auto-style2" style="width: 319px"><strong>New Joinees</strong></td>
		<td class="auto-style5" style="width: 88px"><input id="teacher2" name="Text246" style="width: 101px" type="text" maxlength="4" onblur="return validat_numeric('#teacher2');"/></td>
		<td style="width: 102px" class="auto-style4"><input id="teacher3" name="Text247" style="width: 101px" type="text" maxlength="4" onblur="return validat_numeric('#teacher3');"/></td>
