...
<p><strong>Add Observation Lookup</strong></p>
	...
	<div id = "add" style = " color:#d96a02; text-decoration: none; cursor:pointer;float:left;" onclick = "obsrv_form(1);" >Add 
		Observation Sub Category </div>
	<div id = "add1" style = "color:#d96a02; text-decoration: none; cursor:pointer;float:left;margin-left:20px; New Field" onclick="obsrv_form(2);"> Add 
		Observation Category</div>
<br/>
