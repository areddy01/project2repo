...
<td><table style="width: 71%">
   ...
   <tr>
	...
	<input id="tot_amount<?php echo $row; ?>"type = "text" disabled="disabled" name = "tot_amt[$getval]" value = "<?php if (isset($arr['getvalue'][$getval]['fee_amount'])||isset($arr['getvalue'][$getval]['quantity'])) echo (($arr['getvalue'][$getval]['fee_amount'])*($arr['getvalue'][$getval]['quantity'])*12); ?>" style="width: 158px"/></strong></td>
	...
	<?php  } ?>
	 ...
	 <?php } ?>
			...
			<tr>
				...
				<td style="width: 128px; height: 26px;" ><input name="Text191" id="transportfees78" value="<?php echo $data; ?>" type="text" style="width: 158px" /></td>
...
In case school provides transport, but it doesnt have breakup of students using transport facility by classes.</p>
<input id = "transportfees" name="Submit1" type="submit" value="submit" style="width: 111px"  onclick = "return validate_transport_button(<?php echo count($arr['class_name']);?>);" />
