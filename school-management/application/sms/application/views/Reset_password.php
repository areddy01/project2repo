...
<div id="shell">
	...
	<div id="content">
		...
		<div class="message thank-message">
			...
			<form name = ""  action = "/email_control/changepassword/" method = "POST">
			<?php if (isset($messege))echo $messege ; ?>
			<table cellspacing="15">
			<tr><td colspan="2" align="center" style="height: 23px" ><strong>Change Password</strong></td></tr>
			<tr><td style="height: 26px">Current password  </td>
				<td style="height: 26px"><input type = "password" name ="password" /></td></tr>
			<tr><td>Type New Passsword</td><td><input type = "password" name ="newpassword" /></td></tr>
			<tr><td>Type Again New Password</td><td><input type = "password" name ="newpassword1" /></td></tr>
			<tr><td colspan="2" align="right">
				<input type = "submit" value = "Submit" name ="submit" style="width: 81px" /></td></tr>
					</table>
			</form>
