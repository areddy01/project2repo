...
<div id = "add" style = " color:#d96a02; text-decoration: none; cursor:pointer;float:left;" onclick = "addsub_form(2);" >	Add New Subject </div>
	<div id = "add1" style = "color:#d96a02; text-decoration: none; cursor:pointer;float:left;margin-left:20px; New Field" onclick="addsub_form(1);"> Display Present Values</div>
<br/>
...
<div id = "addcat1" style ="display:none;" >
	...
	<!--<td><?php echo  $arr[$row]['subject_category']; ?></td>-->
	 </tr>
	<?php } ?>
	</table>
	</div>
