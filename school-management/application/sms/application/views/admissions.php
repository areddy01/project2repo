...
<td colspan="5" ><strong>Current Academic Year: &nbsp;<?php echo date("Y"); ?></strong> </td>
	...
	<tr>
		...
		<td style="width: 67px; height: 26px;" >
			<input id ="section<?php echo $row;?>" name="enrollment[<?php echo $row;?>][1]" value = "<?php if(isset($arr[$row]['no_of_sections']))echo $arr[$row]['no_of_sections']; ?>" type="number" onblur="return validate_numeric('#section<?php echo $row;?>');" style="width: 72px" /></td>
		<td style="height: 26px" >
					<input id ="boys<?php echo $row;?>" name="enrollment[<?php echo $row;?>][2]"  value =  "<?php if(isset($arr[$row]['total_enrollment_boys']))echo $arr[$row]['total_enrollment_boys']; ?>" type="number" onblur="return add_cost('#boys<?php echo $row;?>','#girls<?php echo $row;?>','#total<?php echo $row;?>');" style="width: 72px;" /></td>
		<td style="height: 26px" >
					<input id ="girls<?php echo $row;?>" name="enrollment[<?php echo $row;?>][3]"  value =  "<?php if(isset($arr[$row]['total_enrollment_girls'])) echo $arr[$row]['total_enrollment_girls']; ?>"type="number" onblur="return add_cost('#boys<?php echo $row;?>','#girls<?php echo $row;?>','#total<?php echo $row;?>');" style="width: 72px" /></td>
		<td style="height: 26px" >
		 ...
		 ?>" /></td>
		<td style="height: 26px" >
					<input id ="newboys<?php echo $row;?>" name="enrollment[<?php echo $row;?>][4]"  value =  "<?php if(isset($arr[$row]['total_new_admission_boys']))echo $arr[$row]['total_new_admission_boys']; ?>" type="number" onblur="return add_cost('#newboys<?php echo $row;?>','#newgirls<?php echo $row;?>','#newtotal<?php echo $row;?>');" style="width: 72px" /></td> 
		<td style="height: 26px" >
					<input id ="newgirls<?php echo $row;?>" name="enrollment[<?php echo $row;?>][5]"  value =  "<?php if(isset($arr[$row]['total_new_admissions_girls']))echo $arr[$row]['total_new_admissions_girls']; ?>" type="number" onblur="return add_cost('#newboys<?php echo $row;?>','#newgirls<?php echo $row;?>','#newtotal<?php echo $row;?>');" style="width: 72px" /></td>
		<td style="width: 78px; height: 26px;" >
					<input id ="newtotal<?php echo $row;?>" name="" type="number" style="width: 72px" disabled="disabled" value =  "<?php if(isset($arr[$row]['total_new_admission_boys'])||isset($arr[$row]['total_new_admissions_girls'])){
		...
		<td style="width: 74px; height: 26px;" >
					<input id ="freestudent<?php echo $row;?>" name="enrollment[<?php echo $row;?>][6]" type="number" style="width: 72px"  value =  "<?php if(isset($arr[$row]['total_free_admissions_students']))echo $arr[$row]['total_free_admissions_students']; ?>" onblur="return validate_numeric('#freestudent<?php echo $row;?>');" /></td>
	</tr>
	<?php 
	 }?>
...
<td colspan="5" ><strong>PREVIOUS ACADEMIC YEAR:&nbsp;<?php echo date("Y"); ?></strong> </td>
	...
	<tr>
		...
		<td style="width: 67px; height: 26px;" >
			<input id ="sectionprevious<?php echo $row;?>" name="enrollment[<?php echo $row;?>][1]" value = "<?php if(isset($arr[$row]['no_of_sections']))echo $arr[$row]['no_of_sections']; ?>" type="number" onblur="return validate_numeric('#sectionprevious<?php echo $row;?>');" style="width: 72px" /></td>
		<td style="height: 26px" >
					<input id ="boysprevious<?php echo $row;?>" name="enrollment[<?php echo $row;?>][2]"  value =  "<?php if(isset($arr[$row]['total_enrollment_boys']))echo $arr[$row]['total_enrollment_boys']; ?>" type="number" onblur="return add_cost('#boysprevious<?php echo $row;?>','#girls<?php echo $row;?>','#total<?php echo $row;?>');" style="width: 72px;" /></td>
		<td style="height: 26px" >
					<input id ="girlsprevious<?php echo $row;?>" name="enrollment[<?php echo $row;?>][3]"  value =  "<?php if(isset($arr[$row]['total_enrollment_girls'])) echo $arr[$row]['total_enrollment_girls']; ?>"type="number" onblur="return add_cost('#boys<?php echo $row;?>','#girls<?php echo $row;?>','#total<?php echo $row;?>');" style="width: 72px" /></td>
		<td style="height: 26px" >
...
<td colspan="5" ><strong>PREVIOUS ACADEMIC YEAR:&nbsp;<?php echo date("Y"); ?></strong> </td>
	...
	<tr>
		...
		<td style="width: 67px; height: 26px;" >
			<input id ="sectionpreviousyear2<?php echo $row;?>" name="enrollment[<?php echo $row;?>][1]" value = "<?php if(isset($arr[$row]['no_of_sectionsprevious2']))echo $arr[$row]['no_of_sections']; ?>" type="text" onblur="return validate_numeric('#sectionpreviousyear2<?php echo $row;?>');" style="width: 72px" /></td>
...
<input id = "admissions" name="Submit1" type="submit" value="submit" onclick="return validate_admission_button(<?php echo count($arr); ?>);" style="width: 111px" />
