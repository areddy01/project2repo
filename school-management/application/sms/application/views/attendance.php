...
<table style="width: 50%">
		...
		<tr>
			...
			<td style="height: 26px"><input name="Text25" type="text" style="width: 56px" /></td>
			<td style="height: 26px"><input name="Text26" type="text" style="width: 56px" /></td>
			<td style="height: 26px"><input name="Text27" type="text" style="width: 56px" /></td>
		</tr>
		<tr>
			<td class="auto-style3"><strong>No of working Days</strong></td>
		...
		<tr>
			...
			<td style="height: 26px"><input name="NumberofTeachers[]" type="text" style="width: 56px" "<?php if(isset($arr['getvaluelastlastmonth'][0]['no_teachers_attended'])) echo $arr['getvaluelastlastmonth'][0]['no_teachers_attended'] ;?>" /></td>
			<td style="height: 26px"><input name="Text26" type="text" style="width: 56px" /></td>
			<td style="height: 26px"><input name="Text27" type="text" style="width: 56px" /></td>
		</tr>
		<tr>
...
<input id="overdue" name="Submit1" type="submit" value="submit" style="width: 98px" onclick="return validate_overdue_button(<?php echo count($arr); ?>);"/>
