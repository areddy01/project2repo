...
<!--		<td style="width: 179px; height: 7px;">
	...
	<tr>
		...
		<td style="width: 112px">
			...
			<input id = "corrname" name="school_profile[correspondent_name]" type="text" maxlength="50" onblur="return validat_corrspo('#corrname')" value = "<?php if(isset($correspondent_name)) echo $correspondent_name ; ?>"/></td>
	...
	<tr><td style="width: 255px">Pincode:</td> <td style="width: 112px"><input id = "city_pincode" name="school_profile[pincode]" type="text" onblur="return validat_numeric('#city_pincode')" value = "<?php if(isset($pincode)) echo trim($pincode); ?>" maxlength="6" /></td></tr>
...
for ($row = 0; $row < count($arr) ;  $row++) { 
	...
	<?php $facility_sub_cat_name =  $arr[$row]['facility_sub_cat_name'] ; ?>
		...
		<input name="school_facility[]" type="text" value = "<?php if(isset($arr[$row]['facility_sub_cat_value']))echo $arr[$row]['facility_sub_cat_value']; ?>" maxlength="4"/>
