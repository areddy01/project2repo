...
<tr><td >Enter Total Value : </td><td style="width: 155px">
	<input id="tot_val" type="text" name="tol_value" style="width: 144px" onkeyup="javascript: trimalpha('#tot_val');" /></td>
<td style="width: 114px"><input id="tot_val1"  type="submit" value="submit2" onclick="getval_button('#tot_val1');"/>
<div id="message"><cite id="error" style="display:none; color:red">Only Numeric values are allowed</cite>
</div>
</td>
</tr>
</div>
...
<td style="width: 273px; height: 104px;" ><table style="width: 461px" id="mytable">
	...
	<tr>
		...
		<td style="width: 114px; height: 26px;" class="auto-style1">
					<input id ="nos<?php echo $row;?>" name="overdue[<?php echo $row;?>][1]" value =  "<?php if(isset($arr[$row]['no_of_students']))echo $arr[$row]['no_of_students']; ?>" onkeyup="javascript: trimalpha('#nos<?php echo $row;?>')" type="text" style="width: 113px" /></td>
		<td style="width: 116px; height: 26px;" class="auto-style1">
					<input id ="fo<?php echo $row;?>" name="overdue[<?php echo $row;?>][2]"  value =  "<?php if(isset($arr[$row]['fee_overdue']))echo $arr[$row]['fee_overdue']; ?>" onkeyup="javascript: trimalpha('#fo<?php echo $row;?>')" type="text" style="width: 113px" /></td>
	...
	<tr>
		...
		<td style="width: 114px" class="auto-style1">
					<input id="totalstudents<?php echo $tot_no_of_students; ?>" name="totalstudents[4]" type="text" readonly="readonly" value="<?php echo $tot_no_of_students; ?>" style="width: 113px"/>  <!--onblur="return add_res('#overdue1<?php echo $tot_no_of_students; ?>')"--> </td>
		<td style="width: 116px" class="auto-style1">
					<input id="totalfeeoverdue<?php echo $tot_fee_overdue; ?>" name="totalfeeoverdue[5]" type="text"  readonly="readonly" value="<?php echo $tot_fee_overdue; ?>"  style="width: 113px" /><!--onblur="return add_res('#overdue2<?php echo $tot_no_of_students; ?>')"--> </td>
	</tr>
</table>
</td>
...
<td colspan="1" align="right" style="width: 273px; height: 34px;">
  <input id="overdue" name="Submit1" title="only allowed 1-9 values" pattern="[0-9]" type="submit" value="submit" style="width: 98px" onclick="return validate_overdue_button(<?php echo count($arr); ?>);"/></td></tr>
