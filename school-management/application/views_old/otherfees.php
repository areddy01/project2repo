...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
  <script type="text/javascript">function trimalpha(id){
  alert("alert");
var idvalue=$(id).val();
if(isNaN(idvalue)){
$(id).val('');
...
<td><table style="width: 99%">
   ...
   <tr>
	...
	<input type = "text" id="other_fees_values0<?php echo $row; ?><?php echo $row1; ?>" name = "other_fees_values[<?php echo $row; ?>][<?php echo $row1; ?>][fee_amount]" value = "<?php if (isset($arr['getvalue'][$getval]['fee_amount'])) echo $arr['getvalue'][$getval]['fee_amount']; ?>" onblur="return mul_value('#other_fees_values0<?php echo $row; ?><?php echo $row1; ?>','#other_fees_values1<?php echo $row; ?><?php echo $row1; ?>','#other<?php echo $row; ?><?php echo $row1; ?>');"  onkeyup="javascript: trimalpha('#other_fees_values0<?php echo $row; ?><?php echo $row1; ?>')"/></strong></td>
	...
	<?php if ((isset($arr['getvalue'][$getval]['fee_amount'])||isset($arr['getvalue'][$getval]['quantity']))&&$row1==1){$data2=$data2+($arr['getvalue'][$getval]['fee_amount'])*($arr['getvalue'][$getval]['quantity']);}?><!--<strong>
	...
	<?php for ($row = 0; $row < count($arr['fee_name']) ;  $row++) {  ?>
  	      <?php if ($row == 0){ ?>
		     ...
		     <td style="width: 118px"><input name="" id="otherfees78" readonly="readonly"   type="text" style="width: 130px" value="<?php echo $data1; ?>"/></td>
		     <?php }else{ ?>
		     
		     <td style="width: 99px"></td>
	         <td class="auto-style9" ><strong>Total Income</strong></td>
		     <td style="width: 118px"><input name="" id="otherfees78" readonly="readonly"  type="text" style="width: 130px" value="<?php echo $data2; ?>"/></td>
	...
	<?php for ($row = 0; $row < count($arr['fee_name']) ;  $row++) {  ?>
  	      <?php if ($row == 0){ ?>
		     ...
		     <td style="width: 118px"><input name="margin_books" id="otherfees78"    type="text" style="width: 130px" value="<?php echo $arr['getvalue'][0]['margin_books']; ?>"/></td>
		     <?php }else{ ?>
		     
		     <td style="width: 99px"></td>
	         <td class="auto-style9" ><strong>Margin(%)</strong></td>
		     <td style="width: 118px"><input name="margin_etc" id="otherfees78"   type="text" style="width: 130px" value="<?php echo $arr['getvalue'][1]['margin_etc']; ?>"/></td>
	...
	<?php for ($row = 0; $row < count($arr['fee_name']) ;  $row++) {  ?>
  	      <?php if ($row == 0){ ?>
		     ...
		     <td style="width: 118px"><input name="" id="otherfees78"    type="text" style="width: 130px" value="<?php echo $data1*($arr['getvalue'][0]['margin_books']/100); ?>"/></td>
		     <?php }else{ ?>
		     
		     <td style="width: 99px"></td>
	         <td class="auto-style9" ><strong>Net Income</strong></td>
		     <td style="width: 118px"><input name="" id="otherfees78"   type="text" style="width: 130px" value="<?php echo $data2*($arr['getvalue'][1]['margin_etc']/100); ?>"/></td>
...
<input id = "otherfees" name="Submit1" type="submit" value="submit" onclick="return validate_otherfees_button(<?php echo count('#otherfees'); ?>);" style="width: 57px" />
<td align="right"><?php if(isset($message)) echo"$message"; ?></td>
<div><span id="error" style = "display:none;color:red;" > Only Numeric Values are Allowed </span> </div>
</td>
