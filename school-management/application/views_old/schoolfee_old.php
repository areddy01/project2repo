...
<tr>
  ...
  <td class="auto-style4"><strong>Frequency</strong></td>
	<?php for ($row = 0; $row < count($arr) ;  $row++) { 
    if (isset($arr['getvalue'][$row]['class_id'])){
		 if ($arr['getvalue'][$row]['class_id'] ==1)
		$indevalue =$arr['getvalue'][$row]['fee_term_type'];
	?>
     <td><strong><select id="schoolfee0" name="school_fees[<?php echo $row ; ?>][fee_term_type]" style="width: 99px">
	 ...
	 <td>
	 <strong><select id="schoolfee0" name="school_fees[<?php echo $row ; ?>][fee_term_type]" style="width: 99px">
		<option>Select</option>
		<option value="Monthly">Monthly</option>
		<option value="Quaterly">Quaterly</option>
		<option value="Thrice">Thrice</option>
   ...
   <tr>
	...
	<td class="auto-style4"><input type = "text" name = "school_fees_value[<?php echo $row; ?>][<?php echo $row1; ?>]" value = "<?php if (isset($arr['getvalue'][$getvalue]['fee_amount'])) echo $arr['getvalue'][$getvalue]['fee_amount'] ; ?>"/></strong></td>
	<?php $getvalue++; ?>
	<?php } ?>
...
<table border="0"  width="71%">
  ...
  <tr><!-- Row 1 -->
     ...
     <td><input id="nuradmin3" type="text" name="schfee[coll_tut_curr]" value="" style="width: 95px"/></td><!-- Col 2 -->
     <td><input id="nuradmin3" type="text" name="schfee[coll_tut_prev]" value="" style="width: 95px"/></td><!-- Col 3 -->
  </tr>
  <tr><!-- Row 1 -->
     <td class="auto-style4"><strong>Rent from School building</strong></td><!-- Col 1 -->
     <td><input id="nuradmin3" type="text" name="schfee[rent_curr]" value="" style="width: 95px"/></td><!-- Col 2 -->
     <td><input id="nuradmin3" type="text" name="schfee[rent_prev]" value="" style="width: 95px"/></td><!-- Col 3 -->
  </tr>
  <tr><!-- Row 1 -->
     <td class="auto-style4"><strong>Others(1)</strong></td><!-- Col 1 -->
     <td><input id="nuradmin3" type="text" name="schfee[others_curr]" value="" style="width: 95px"/></td><!-- Col 2 -->
     <td><input id="nuradmin3" type="text" name="schfee[others_prev]" value="" style="width: 95px"/></td><!-- Col 3 -->
  </tr>
  <tr><!-- Row 1 -->
     <td class="auto-style4"><strong>Donations</strong></td><!-- Col 1 -->
     <td><input id="nuradmin3" type="text" name="schfee[donations_curr]" value="" style="width: 95px"/></td><!-- Col 2 -->
     <td><input id="nuradmin3" type="text" name="schfee[donations_prev]" value="" style="width: 95px"/></td><!-- Col 3 -->
  </tr>
</table>
...
<tr>
<td align="center">
<input id = "send" name="Submit1" type="submit" value="submit" onclick ="return validate_school();" style="width: 124px"/><span id="error" style = "display:none;color:red;" > Only Numeric Values are Allowed </span> <span id ="errmark" style = "display:none;color:red;" > All Red mark field is required </span></td>
