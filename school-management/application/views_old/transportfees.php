...
<td><table style="width: 71%">
   ...
   <tr>
	...
	<input type = "text" id="transport_fee_value0<?php echo $row; ?>" name ="transport_fees_values[<?php echo $row; ?>][<?php echo $row1; ?>][fee_amount]" value = "<?php if (isset($arr['getvalue'][$getval]['fee_amount'])) echo $arr['getvalue'][$getval]['fee_amount']; ?>" style="width: 158px" onkeyup="return multi_value('#transport_fee_value0<?php echo $row; ?>','#transport_fee_value1<?php echo $row; ?>','#tot_amount<?php echo $row; ?>');"  /></strong></td>
	<td style="height: 26px; width: 162px;"><strong>
	<input type = "text" id="transport_fee_value1<?php echo $row; ?>"name ="transport_fees_values[<?php echo $row; ?>][<?php echo $row1; ?>][quantity]" value = "<?php if (isset($arr['getvalue'][$getval]['quantity'])) echo $arr['getvalue'][$getval]['quantity']; ?>" style="width: 158px" onkeyup="return multi_value('#transport_fee_value0<?php echo $row; ?>','#transport_fee_value1<?php echo $row; ?>','#tot_amount<?php echo $row; ?>');" /></strong></td>
	<td style="height: 26px; width: 158px;"><strong>
	
 <input id="tot_amount<?php echo $row; ?>" type ="text"  name ="" readonly="readonly" value ="<?php if (isset($arr['getvalue'][$getval]['fee_amount'])||isset($arr['getvalue'][$getval]['quantity'])) echo (($arr['getvalue'][$getval]['fee_amount'])*($arr['getvalue'][$getval]['quantity'])*12); ?>" style="width: 158px"/></strong></td>"
	...
	<?php  } ?>
	 ...
	 <?php } ?>
			...
			<tr>
				...
				<td style="width: 128px; height: 26px;" ><input id="tot_income<?php echo $row; ?>" type = "text"  name ="" readonly="readonly" value = "<?php echo $data;  ?>" style="width: 158px"/></td>
