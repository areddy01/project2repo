...
<div id="shell">
	...
	<div id="content">
		<div class="message thank-message">
			...
			<form name = "" action = ""  method = "/email_control/changepassword/">
			<label>Current password<label><div style ="float:right;margin-"> <input type = "text" name ="password" ></div><br />
			<label>Type New Passsword<label><div><input type = "text" name ="newpassword" ></div><br />
			<label>Type Again New Password<label><div><input type = "text" name ="newpassword1" ></div><br />
