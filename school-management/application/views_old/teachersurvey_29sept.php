...
<form method = "post" id ="" action = "/admin/addteachersurvey/?info=<?php echo $info ; ?>"    style="width:79%; height: 167px;">
  ...
  <tr ><!-- Row 1 -->
	 ...
	 <td >
		 <strong>
		 <input type = "text" readonly = "readonly" cursur = "disabled" value = "<?php $value =($resp/54)+1 ;echo("T$value") ;?>" name = "response[]" size="20" style="width: 92px" class="auto-style10" /></strong></td>
	   </tr><!-- Row 1 -->
  
 
 <?php  $row1=1; $survey_cat_id =$arr['setvalues'][0]['survey_cat_id'];
  ...
  <tr style="background-color:#008000"><!-- Row 1 -->
   ...
   <td class="auto-style9" style="width: 28px"><?php echo $row1++; ?></td>
     ...
     <td> 
		 <select id="teachersur<?php echo($row);?>0" name="teacher_response[0][<?php echo($row);?>]" value = "<?php echo $arr['setvalues'][$row]['survey_sub_cat_id']; ?>" style="width: 87px" >
...
<input type = "text" value = "" name = "teacher_response[]">
 <?php } ?>
