...
<tr>
<td>
<form method="post" action="/admin/addcost/?info=<?php echo $info;?>" enctype="multipart/form-data">
...
<?php } ?>
   ...
   <td class="auto-style9" style="width: 82px"><?php echo $row1++; ?> </td>
	 ...
	 <td><select id="xtimes<?php echo $row ;?>" name="quantity[1][<?php $row ?>]" style="width: 89px" onchange="return multiplication('#amt<?php echo $row ?>','#xtimes<?php echo $row; ?>','#tot<?php echo $row; ?>');">
...
<input id = "cost" name="Submit1" type="submit" value="submit" onclick="return validate_cost_button('<?php echo count($arr['setvalues']); ?>');" style="width: 57px" />
