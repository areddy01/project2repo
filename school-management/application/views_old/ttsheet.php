...
<input id = "numbofrow1" type = "text" value = "" name = "numbofrow" maxlength="2" onblur="return validat_numeric('#numbofrow1');" ></td>
<input name="Submit2" type="submit" value="submit" onclick ="return validate_numeric('#numbofrow1');" style="width: 113px" />
</div>
</form>
 </div>

<form method = "post" id ="" action = "/teacher_test/getdata/update/?info=<?php echo $info ;?>"  style="width:100%; ">
...
<?php }else {?>
<td class="auto-style3" style="width: 100px">
<input id="teachername" type ="text" name = "teachername[]" value = "" onblur=" return validate_alphabets('#teachername');" />
...
<tr>
<td>
<input id="submit" name="Submit1" type="submit" value="submit" onclick="return validate_teacher('#submit');"  style="width: 113px" />
</td>
</tr>
<tr><td><?php if(isset($message)) echo "$message"; ?></td></tr>
<?php }?>
