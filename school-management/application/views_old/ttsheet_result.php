...
<div id = "leftPolicy" onclick = "calling(1);" style = "text-decoration:underline;cursor:pointer;" >Enter New Teacher Detail</div>&nbsp;&nbsp; &nbsp;<div id = "leftPolicy2"  onclick = "calling(0);"  style = "text-decoration:underline;cursor:pointer;" > Edit existing detail
</div>
