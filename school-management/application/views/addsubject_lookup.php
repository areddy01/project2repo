...
<div id = "add" style = " color:#d96a02; text-decoration: none; cursor:pointer;float:left;margin-left:350px;" onclick = "addsub_form(2);" >Add New Field </div>
...
<div id = "addcat1" style ="display:none;" >
	...
	<input class="btnbg addform" type ="Submit"  value = "Add New Field" name ="submit" ></td></tr>
