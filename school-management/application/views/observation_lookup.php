...
<br/>
	...
	<div id = "add" style = " color:#d96a02; text-decoration: none; cursor:pointer;float:left;margin-left:350px;" onclick = "obsrv_form(1);" >Add New Field </div>
...
<input  class="btnbg addform" type ="Submit"  align="right" value = "Add New Field" name ="submit" >
...
<?php } ?>
	...
	<tr><td colspan="2" align="center"><input class="btnbg addform" type ="Submit"  value = "Add New Field" name ="submit" ></td></tr>
