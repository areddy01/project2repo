...
<input id = "numbofrow1" type = "text" value = "" name = "numbofrow" onblur="return validat_numeric('#numbofrow1')"  maxlength="2" ></td>
<input name="Submit2" type="submit" value="submit" style="width: 113px" onclick="return validate_numeric('#numbofrow1');"  />
</div>
</form>
 </div>
...
<form method = "post" id ="" action = "/student_test/input/insert/?info=<?php echo $info ;?>"  value = ""  style="width:100%; ">
<?php
//echo "<pre>";
//print_r($arr);
//$entervalue = 0;
...
<?php }else {?>
<td class="auto-style3" style="width: 100px">
<input type ="text" name = "studentname[0]" value = "" onblur="return validate_alphabets('#studentname');"  maxlength="30"/>

<input id="studentname" type = "hidden" name = "requesttest" value = "<?php echo $requesttest ; ?>"   />
</td>

<td class="auto-style3" style="width: 100px">
<input id="rollno" type="text" name="student1[]" maxlength="3" onblur="return validate_numeric('#rollno')" />
