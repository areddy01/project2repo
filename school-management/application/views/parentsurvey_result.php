...
<a href ="/admin/parentsurvey/?info=<?php echo $info; ?>"> Observations main </a>
	<!-- End Header -->
	...
	?>
<select id="teachersur"  name="response[0]">
...
<td><table border="0"  width="100%">
  <tr ><!-- Row 1 -->
	 ...
	 <div align="center" class="auto-style3"><strong><input type="text" value ="<?php echo $_REQUEST['response'][0]; ?>" name = "response[0]" readonly ="readonly" /></strong></div></td>
	   </tr>
  <tr ><!-- Row 1 -->
     <td class="auto-style3" colspan="2">
	 <div align="right" class="auto-style5"><strong>Class of the student </strong></div></td><!-- Col 1 -->
      <!-- Col 2 -->
