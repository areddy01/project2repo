...
<br/>
	<div id = "add" style = " color:#d96a02; text-decoration: none; cursor:pointer;float:left;margin-left:350px;" onclick = "qual_form(2);" >Add New Field </div>
...
<br/>
	...
	<div id = "addcat1" style ="display:none;" >
		...
		<tr>
			<td colspan="2" align="center"><input class="btnbg addform"  type ="Submit"  value = "Add New Field" name ="submit" ></td>
		</tr>
		</table>
	...
	<div id ="addnewfield" style ="display:none;" >
		<table>
			...
			<tr>
			<td><?php echo $arr[$row]['qualification_name'];?> </td>
			</tr>
				<?php } ?>
		</table>	
	</div>
