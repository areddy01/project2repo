...
<div id="shell">
	...
	<?php    $this->load->view('dashboard', $info ); ?>
		<div class="message thank-message">
			...
			<div align="left">
			<label><b>Infra Details </b></label>
<form method = "post" id ="" action = "/infra/input?school_name=<?php echo $_REQUEST['school_name'];?>&school_code=<?php echo $_REQUEST['school_code'];  ?>"  value = ""  style="width:40%" class = "customForm">
<table>
<tr>
<td><table border="0" cellpadding="1" style="width: 100%" >
	<tr>
		...
		<input id = "schoolname" name="school_profile[school_name]" style="width: 539px" type="text" value = "<?php echo $_REQUEST['school_name']; ?> "/></td>
	</tr>
	<tr>
		<td style="width: 293px">School Name for Graphs</td>
		<td style="width: 179px">
		<input id = "schoolgraph" name="school_profile[school_desc]" type="text" value = "<?php echo $school_desc ; ?>" /></td>
		<td>APS average</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="width: 179px">
		<input id = "year_of_estd" name="school_profile[year_of_estblished]" type="text" value = "<?php echo $year_of_estblished ; ?>"/></td>
		<td rowspan="2">School assessed by<br />
		( initials only)</td>
		<td><input id = "sch_assessed_by" name="assessment[school_assessed_by]" type="text" value = "<?php echo $school_assessed_by ; ?>"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="height: 24px"><input id = "date_of_assessment" name="assessment[assessment_date]" type="text" readonly="readonly" style="color:#000000; margin:-2px 0px 0px 0px;vertical-align:top;" value = "<?php echo $assessment_date ; ?> "/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr>
		...
		<td style="width: 179px">
			<input id="accreditation" name="school_profile[accredition]" type="text" value = "<?php echo $accredition; ?>"/></td>
		<td rowspan="2"><select name="assessment[assessment_type_if_re_assessed]" style="width: 88px">
	...
	<tr>
		...
		<td style="width: 179px">
			...
			<input id="qualification" name="school_profile[qualification]" type="text" value = "<?php echo $qualification ; ?>"/></td>
	</tr>
	<tr>
		<td style="width: 293px">Correspondant Name ( Include salutation)</td>
		<td style="width: 179px">
		
			<input id = "corrname" name="school_profile[correspondent_name]" type="text" value = "<?php echo $correspondent_name ; ?>"/></td>
		<td>School Code</td>
		<td>
		
			<input id = "Sch_code" name="school_profile[school_code]" style="width: 88px" type="text"  value = "<?php echo $_REQUEST['school_code'];  ?>"/></td>
	</tr>
	<tr>
		<td style="width: 293px">Phone No.</td>
		<td style="width: 179px">
		
			<input id = "ph_no" name="school_profile[phone_no]" type="text" value ="<?php echo $phone_no ; ?>"/><div id = "phonenum" style = "display:none;color:red;">Type a valid phone numebr please</div></td>
		<td>Co-education</td>
		<td>
	...
	<tr>
		...
		<td colspan="3">
			...
			<input id = "sch_mail_add" name="school_profile[school_mailing_address]" type="text" value = "<?php echo $school_mailing_address ; ?>"/><div id = "emailinfo" style = "display:none;color:red;">Type a valid e-mail please</div></td>
	</tr>
	<tr>
		<td style="width: 293px">
		<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;width:248pt" width="331">
		...
		<td colspan="3">
			...
			<input id = "" name="school_profile[city]" type="text" value = "<?php echo $city ; ?>"/></td>
	</tr>
	<tr><td>Pincode:</td> <td><input id = "city_pincode" name="school_profile[pincode]" type="text" value = "<?php echo $pincode; ?> "/></td></tr>
	<tr><td colspan="4"><br />
...
for ($row = 0; $row < count($arr) ;  $row++) { 
	...
	<?php $facility_sub_cat_name =  $arr[$row]['facility_sub_cat_name'] ; ?>
		...
		<input name="school_id[]" type="hidden" value = "<?php echo $arr[$row]['facility_sub_cat_id'];?>"/>
