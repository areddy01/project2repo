...
<td><table border="0" cellpadding="1" style="width: 100%" >
	<tr>
		...
		<input id = "schoolname" name="school_profile[school_name]" style="width: 539px" type="text" value = "<?php if(isset($_REQUEST['school_name'])) echo $_REQUEST['school_name']; ?> "/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="width: 179px">
		<input id = "year_of_estd" name="school_profile[year_of_estblished]" type="text" onblur="return validat_nulls('#year_of_estd')" value = "<?php  if(isset($year_of_estblished)) echo $year_of_estblished ; ?>"/></td>
		<td rowspan="2">School assessed by<br />
		( initials only)</td>
		<td><input id = "sch_assessed_by" name="assessment[school_assessed_by]" type="text" onblur="return validat_nulls('sch_assessed_by')" value = "<?php if(isset($school_assessed_by)) echo $school_assessed_by ; ?>"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="height: 24px"><input id = "date_of_assessment" name="assessment[assessment_date]" type="text" readonly="readonly" style="color:#000000; margin:-2px 0px 0px 0px;vertical-align:top;" onblur="return validat_nulls('#date_of_assessment')" value = "<?php if(isset($assessment_date)) echo $assessment_date ; ?> "/></td>
	</tr>
	<tr bgcolor="#FFFFFF">
	...
	<tr>
		...
		<td>
			...
			<input id = "Sch_code" name="school_profile[school_code]" style="width: 88px" type="text" onblur="return validat_nulls('#Sch_code')"  value = "<?php if(isset($_REQUEST['school_code'])) echo $_REQUEST['school_code'];  ?>"/></td>
	</tr>
	<tr>
		<td style="width: 293px">Phone No.</td>
		<td style="width: 179px">
		
			<input id = "ph_no" name="school_profile[phone_no]" type="text" onblur="return validat_nulls('#ph_no')" value ="<?php if(isset($phone_no)) echo $phone_no ; ?>"/><div id = "phonenum" style = "display:none;color:red;">Type a valid phone numebr please</div></td>
		<td>Co-education</td>
		<td>
	...
	<tr><td>Pincode:</td> <td><input id = "city_pincode" name="school_profile[pincode]" type="text" onblur="return validat_nulls('#city_pincode')" value = "<?php if(isset($pincode)) echo $pincode; ?> "/></td></tr>
	<tr><td colspan="4"><br />
