...
<div id="shell">
	...
	<div id="content">
		...
		<div class="message thank-message">
			...
			<div align="left">
				<span id="formDetail" style="color:#085890; margin-top: -31px; height:31px; width: 200px;">
					<h2>Infra Details</h2>
				</span>

<form id="infra" name="infra" method = "post"  action = "/infra/input/?info=<?php echo $info; ?>" >
<table class="infra">
<tr>
<td style="width: 904px; height: 687px;">
<table border="0" bordercolor="#FF9933" cellpadding="1" style="width: 102%; height: 431px;" >
<tr><td id="schoolgrapherr" style="color:red;"></td></tr>
<tr><td id="phoneerr" style="color:red;"></td></tr>
<tr><td id="city_pincodeerr" style="color:red;"></td></tr>
	...
	<tr>
		...
		<input id = "schoolgraph" style="width:100px;" name="school_profile[school_desc]" type="text" onblur="return validat_nulls('#schoolgraph')" maxlength="8"  value = "<?php  if(isset($school_desc)) echo $school_desc ; ?>" />
		</td>
...
<!--		<td style="width: 179px; height: 7px;">
	...
	<tr>
		...
		<td style="width: 112px; height: 26px;">
			...
			<input id = "ph_no" style="width:100px;"  name="school_profile[phone_no]"  type="text" onblur="return validat_numeric('#ph_no')" value ="<?php if(isset($phone_no)) echo $phone_no ; ?>" maxlength="12"/>
	...
	<tr>
		...
		<td colspan="3">
			...
			<input id = "city" style="width:100px;" name="school_profile[city]"  type="text"  onblur="return validat_city('#city')"  value = "<?php if(isset($city))  echo $city ; ?>" maxlength="30"/>
	...
	<tr><td style="width: 255px">Pincode:</td> <td style="width: 112px"><input style="width:100px;" id = "city_pincode" name="school_profile[pincode]" type="text" onblur="return validat_numeric('#city_pincode')" value = "<?php if(isset($pincode)) echo trim($pincode); ?>" maxlength="6" /></td></tr>
...
for ($row = 0; $row < count($arr);  $row++) { 
	...
	?>
	<input type="hidden" id="counts" name="counts" value="<?php echo count($arr); ?>" />
	...
	<?php $facility_sub_cat_name =  $arr[$row]['facility_sub_cat_name'] ; ?>
		...
		<input name="school_facility[]" id="school_facility<?php echo $row; ?>"  style="width:100px;" type="text" value = "<?php if(isset($arr[$row]['facility_sub_cat_value']))echo $arr[$row]['facility_sub_cat_value']; ?>" maxlength="4"/>
	...
	?>	
	<select name = "school_facility[]"  style="width:100px;">
...
<input  class="btnbg addform" id = "send" name="Submit1" type="button" onclick="javascript:infra_validate();" value="submit" style="width: 91px" />
