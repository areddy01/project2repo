...
if(schoolinfo.val()!= '' && schoolgraph.val()  != '' && year_of_estd.val()  != '' && date_of_assessment.val() != '' && sch_assessed_by.val() != '' && accreditation.val()!='' && qualification.val()!=  '' && corrname.val() !=  '' && Sch_code.val() !=  '' && ph_no.val() !=  '' && sch_mail_add.val() !=  '' && city.val() != '' && city_pincode.val() !=  '' && ownership.val() !=  '' && no_of_classrooms.val() !=  '' && area.val() != '' && no_of_comps.val() != ''){
...
function getval_button(validval)
{

var textbox = $(validval).val();
 if((textbox< 0)){
$('#error').show();
return false;
}
