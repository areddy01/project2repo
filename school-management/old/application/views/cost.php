   ...
   <td class="auto-style9" style="width: 82px"><?php echo $row1++; ?> </td>
	 ...
	 <td><select id="xtimes<?php echo $row ;?>" name="quantity[1][<?php $row ?>]" style="width: 89px" onblur="return mul_value('#amt<?php echo $row ?>','#xtimes<?php echo $row; ?>','#tot<?php echo $row; ?>');">
		...
		<?php }	?>
		 ...
		 <td><input id="quantity[5]<?php echo $row;?> " type="text" name="quantity[5][<?php echo $row; ?>]" value="<?php if (isset($arr['getvalue1'][$countval]['loan1']))  echo $arr['getvalue1'][$countval]['loan1']; ?>" onblur="return validate_numeric('quantity[5]<?php echo $row;?>')"  />    </td>
