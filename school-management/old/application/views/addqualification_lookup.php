...
<p></p>
<p><strong>Add Qualification Lookup</strong></p>


<div id = "add" style = " color:#d96a02; text-decoration: none; cursor:pointer;float:left;" onclick = "qual_form(2);" >Add New Field </div>
	<div id = "add1" style = "color:#d96a02; text-decoration: none; cursor:pointer;float:left;margin-left:20px; New Field" onclick="qual_form(1);"> Display Values</div>
<br/>
...
<div id = "addcat1" style ="display:none;" >
	 <form name = "myfrom" id = "showschool" action = "/lookup_controller/submitform_data "  method  = "POST">
			 ...
			 <tr>
				 ...
				 <td><input type ="text" value = "" name = "ref_qualification[qualification_name]" >this value will dispaly on label</td>
			 </tr>
			 <tr><td colspan="2"><input  type ="Submit"  value = "Add New Field" name ="submit" ></td></tr>
				 </table>
				<input type =  "hidden"  name = "formname" value = "qualification" >
				</form></div>
	...
	<table>
	<tr><td><strong>Qualification Name</strong></td></tr>
		<?php for ($row = 0; $row < count($arr) ;  $row++) {  ?>
	<tr><td><?php echo $arr[$row]['qualification_name'];?> </td>
	 </tr>
	<?php } ?>
	</table>
	</div>
