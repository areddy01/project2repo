...
<table border="0"  width="71%">
  ...
  <tr><!-- Row 1 -->
     ...
     <td style="width:100px"><input id="nuradmin3" type="text" name="schfee[coll_tut_curr]" maxlength="10" value="<?php if(isset($coll_tut_curr)) { echo $coll_tut_curr; } ?>" style="width: 100px" onblur="return validate_numeric('#nuradmin3') " /></td> <!-- Col 2 -->
   <!-- <td style="width:100px"><input id="nuradmin3" type="text" name="" value="schfee[coll_tut_curr]" style="width: 100px"/></td> --><!-- Col 2 -->
    
     <td style="width:100px"><input id="nuradmin4" type="text" name="schfee[coll_tut_prev]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin4') " /></td><!-- Col 3 -->
  </tr>
  <tr><!-- Row 1 -->
     <td class="auto-style4"><strong>Rent from School building</strong></td><!-- Col 1 -->
     <td><input id="nuradmin5" type="text" name="schfee[rent_curr]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin5')"/></td><!-- Col 2 -->
     <td><input id="nuradmin6" type="text" name="schfee[rent_prev]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin6')" /></td><!-- Col 3 -->
  </tr>
  <tr><!-- Row 1 -->
     <td class="auto-style4"><strong>Others(1)</strong></td><!-- Col 1 -->
     <td><input id="nuradmin7" type="text" name="schfee[others_curr]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin7')"/></td><!-- Col 2 -->
     <td><input id="nuradmin8" type="text" name="schfee[others_prev]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin8')"/></td><!-- Col 3 -->
  </tr>
  <tr><!-- Row 1 -->
     <td class="auto-style4"><strong>Donations</strong></td><!-- Col 1 -->
     <td><input id="nuradmin9" type="text" name="schfee[donations_curr]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin9')" /></td><!-- Col 2 -->
     <td><input id="nuradmin10" type="text" name="schfee[donations_prev]" maxlength="10" value="" style="width: 100px" onblur="return validate_numeric('#nuradmin10')" /></td><!-- Col 3 -->
  </tr>
</table>
