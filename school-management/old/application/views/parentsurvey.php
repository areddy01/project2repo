...
<select id="parentsur"  name="response[0]">
<?php if ($resp != 0){ $R1 = 0; ?>
...
<td><table border="0"  width="100%">
  <tr ><!-- Row 1 -->
	 ...
	 <div align="center" class="auto-style3"><input type = "text" readonly = "readonly" value = "<?php $value =($resp/27)+1 ;echo "R$value" ;?>" name = "response[0]" /> </div></td>
	   </tr>
  <tr ><!-- Row 1 -->
     <td class="auto-style3" colspan="2">
...
<tr><td><?php if(isset($confirm)) echo "$confirm"; ?></td></tr>
</table>				 
