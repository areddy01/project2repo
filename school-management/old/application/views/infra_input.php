...
<!--		<td style="width: 179px; height: 7px;">
	...
	<tr>
		...
		<td style="width: 112px">
			...
			<input id = "corrname" name="school_profile[correspondent_name]" type="text" maxlength="50"  value = "<?php if(isset($correspondent_name)) echo $correspondent_name ; ?>" onblur="return validat_corres('#corrname')" /></td>
	...
	<tr>
		...
		<td colspan="3">
			...
			<input id = "city" name="school_profile[city]" type="text"  onblur="return validate_city('#city')"  value = "<?php if(isset($city)) echo $city ; ?>" maxlength="30"/>
	...
	<tr><td style="width: 255px">Pincode:</td> <td style="width: 112px"><input id = "city_pincode" name="school_profile[pincode]" type="text" onblur="return validate_numeric('#city_pincode')" value = "<?php if(isset($pincode)) echo trim($pincode); ?>" maxlength="6" /></td></tr>
	<tr><td colspan="4" style="height: 22px"><br />
		<strong>FACILITIES</strong></td></tr></tr>
<tr>		
