...
<td><table style="width: 99%">
   ...
   <tr>
	...
	<input type = "text" id="other_fees_values0<?php echo $row; ?><?php echo $row1; ?>" name = "other_fees_values[<?php echo $row; ?>][<?php echo $row1; ?>][fee_amount]" value = "<?php if (isset($arr['getvalue'][$getval]['fee_amount'])) echo $arr['getvalue'][$getval]['fee_amount']; ?>" onblur="return validate_numeric('#other_fees_values0<?php echo $row; ?><?php echo $row1; ?>','#other_fees_values1<?php echo $row; ?><?php echo $row1; ?>','#other<?php echo $row; ?><?php echo $row1; ?>');" /></strong></td>
	<td style="height: 25px"><strong>
	<input type = "text" id="other_fees_values1<?php echo $row; ?><?php echo $row1; ?>" name = "other_fees_values[<?php echo $row; ?>][<?php echo $row1; ?>][quantity]" value = "<?php if (isset($arr['getvalue'][$getval]['quantity'])) echo $arr['getvalue'][$getval]['quantity']; ?>" onblur="return validate_numeric('#other_fees_values1<?php echo $row; ?><?php echo $row1; ?>','#other_fees_values0<?php echo $row; ?><?php echo $row1; ?>','#other<?php echo $row; ?><?php echo $row1; ?>');" /></strong></td>
...
<tr> 
<td align="right"><input id = "" name="Submit1" type="submit" value="submit" onclick="return validate_otherfees_button('#other<?php echo $row; ?>');" style="width: 57px" />
